...
class TopSkills extends StatelessWidget {
  ...
  static const List<({String label, String url})> _skills = [
    (
      label: 'Flutter',
      url:
    ...
    (
      label: 'Dart',
      url: 'https://avatars.githubusercontent.com/u/1609975?s=280&v=4',
    ),
    (
      label: 'Firebase',
      url:
...
class SkillCard extends StatefulWidget {
  ...
  const SkillCard({super.key, required this.label, required this.url});
